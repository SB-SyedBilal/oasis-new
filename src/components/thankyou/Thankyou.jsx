const ThankYou = () => {
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 px-4 py-12">
            {/* Thank You Card */}
            <div className="mb-8 w-full max-w-md rounded-lg bg-white p-8 shadow-sm">
                {/* Thumbs Up Icon */}
                ...
                <h2 className="mb-6 text-center text-lg">Your Submission Received Successfully</h2>

                {/* Message */}
                <p className="mb-8 text-center text-gray-700">
                    Thank you for visiting The Oasis Academy. One of our representative will be in touch shortly.
                </p>

                {/* Go Back Button */}
                <div className="flex justify-center">
                    <a href="/" className="rounded bg-green-600 px-6 py-3 text-center font-medium text-white hover:bg-green-700">
                        Go Back To Home
                    </a>
                </div>
            </div>
            ...
            <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-sm">
                <h2 className="mb-6 text-center text-xl font-bold">Contact with us</h2>
